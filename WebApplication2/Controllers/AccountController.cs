    ...
    public class AccountController : Controller
    {
       ...
       [TempData]
        ...
        public async Task<IActionResult> RegisterExit()
        {
            ...
            try
            {
                check.ExitTime = DateTime.Now.ToString("HH:mm");
            ...
            return BadRequest("لطفا وارد شوید");
        }
        /// <summary>
        ///        SELECT UserName, EntranceDate, EntranceTime, ExitTime
       // FROM[EntranceExit]
     //   inner join[User] on[User].Id = ApplicationUserId
    //  order by UserName, EntranceDate
        /// </summary>
        /// <returns></returns>
        //public async Task<IActionResult> ReportMounthly()
        //{
        //    var user = await _userManager.GetUserAsync(User);
        //    if (user == null)
        //    {
        //        throw new ApplicationException($"Unable to load user with ID '{_userManager.GetUserId(User)}'.");
        //    }
        //    var report = await _context.EntranceExits
        //        .Include(e => e.ApplicationUser).Where(e=>e.ApplicationUserId== )
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            // If we got this far, something failed, redisplay form
             return View(model);
            //var t = new ValidationFailedResult(ModelState);
            //var tt = JsonConvert.<LoginViewModel>();
            //// return BadRequest(new ValidationFailedResult(ModelState));
            //return BadRequest();
        ...
        //    //var person = await _context.EntranceExits.Where(m => m.Id == id).FirstOrDefault();
        //    //if (person == null)
        //    //{
        //    //    return NotFound();
        //    //}
