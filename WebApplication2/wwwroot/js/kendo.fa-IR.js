...
kendo.ui.FilterMenu.prototype.options.messages =
  $.extend(kendo.ui.FilterMenu.prototype.options.messages, {
	 ...
	 ***************************************************************************/
    info: "فیلتر بر اساس:",  //"نشان دادن مواردی که:"      // sets the text on top of the filter menu
	filter: "فیلتر",      // sets the text for the "Filter" button
	clear: "پاک کردن",        // sets the text for the "Clear" button
	// when filtering boolean numbers
	isTrue: "درستی", // sets the text for "isTrue" radio button
	isFalse: "نادرستی",     // sets the text for "isFalse" radio button
...
//kendo.ui.Upload.prototype.options.mes
kendo.ui.Upload.prototype.options.localization =
    ...
    dropFilesHere: "کشیدن فایل به اینجا",
    headerStatusPaused: "متوقف شده",
    headerStatusUploaded: "انجام شد",
    headerStatusUploading: "درحال بارگزاری...",
    invalidFileExtension: "فرمت فایل اشتباه است",
    invalidFiles: "فایل نادرست است.لطفا دوباره چک شود",
    invalidMaxFileSize: "سایز فایل زیاد است",
    invalidMinFileSize: "سایز فایل کم است",
    pause: "توقف",
    remove: "حذف",
    resume: "از سرگیری",
    retry: "تلاش دوباره",
    select: "انتخاب فایل",
    statusFailed: "با شکست مواجه شد",
    statusUploaded: "بارگزاری شد",
    statusUploading: "درحال بارگزاری",
    statusWarning: "اخطار",
    uploadSelectedFiles: "ارسال"
        /***************************************************************************/
    });
